package com.eazibanking.nibss.services;

import com.eazibank.nibss.NibssModuleConfig;
...
import com.eazibank.nibss.services.NibssInterfaceServiceImpl;
...
@SpringBootTest
@ContextConfiguration(classes = NibssModuleConfig.class)
