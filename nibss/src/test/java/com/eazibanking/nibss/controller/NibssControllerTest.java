package com.eazibanking.nibss.controller;

import com.eazibank.nibss.controller.NibssController;
...
class NibssControllerTest {
    ...
    void whenBvnGeneratorCalled_AndNullRequestBody_ThenReturns400Test() throws Exception {
        CreateBvnDto request = new CreateBvnDto();
        this.mockMvc.perform(post("/api/v1/nibss/bvn-generator")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
...
//        CreateBvnDto createCustomerRequest = new  CreateCustomerRequest("Ayobaye", "Ogundele",
